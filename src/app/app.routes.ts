...
export const routes: Routes = [
	{path: 'login', loadComponent: () => import('./pages/login/login.component').then(m => m.LoginComponent)},
	{
		...
		[
			...
			{path: 'list-attribute', loadComponent: () => import('./pages/list-attribute/list-attribute.component').then(m => m.ListAttributeComponent), canActivate: [authGuard]},
			{path: 'add-attribute', loadComponent: () => import('./pages/save-attribute/save-attribute.component').then(m => m.SaveAttributeComponent), canActivate: [authGuard]},
			{path: 'edit-attribute/:id', loadComponent: () => import('./pages/save-attribute/save-attribute.component').then(m => m.SaveAttributeComponent), canActivate: [authGuard]},
			...
			{path: 'list-account', loadComponent: () => import('./pages/list-account/list-account.component').then(m => m.ListAccountComponent), canActivate: [authGuard]},
			...
			*/
			...
			{path: 'list-storage-type', loadComponent: () => import('./pages/list-storage-type/list-storage-type.component').then(m => m.ListStorageTypeComponent), canActivate: [authGuard]},
			{path: 'add-storage-type', loadComponent: () => import('./pages/save-storage-type/save-storage-type.component').then(m => m.SaveStorageTypeComponent), canActivate: [authGuard]},
			{path: 'edit-storage-type/:id', loadComponent: () => import('./pages/save-storage-type/save-storage-type.component').then(m => m.SaveStorageTypeComponent), canActivate: [authGuard]},
			...
			{path: 'list-bank-movement', loadComponent: () => import('./pages/list-bank-movement/list-bank-movement.component').then(m => m.ListBankMovementComponent), canActivate: [authGuard]},
			{path: 'list-bank-account', loadComponent: () => import('./pages/list-bank-account/list-bank-account.component').then(m => m.ListBankAccountComponent), canActivate: [authGuard]},
			{path: 'add-bank-account', loadComponent: () => import('./pages/save-bank-account/save-bank-account.component').then(m => m.SaveBankAccountComponent), canActivate: [authGuard]},
			{path: 'edit-bank-account/:id', loadComponent: () => import('./pages/save-bank-account/save-bank-account.component').then(m => m.SaveBankAccountComponent), canActivate: [authGuard]},
			...
			{path: 'reporte-estado-cuenta-proveedor', loadComponent: () => import('./pages/reporte-estado-cuenta-proveedor/reporte-estado-cuenta-proveedor.component').then(m => m.ReporteEstadoCuentaProveedorComponent), canActivate: [authGuard]},
		...
		{path: 'view-payment/:id', loadComponent: () => import('./pages/view-payment/view-payment.component').then(m => m.ViewPaymentComponent), canActivate: [authGuard]},
			...
			{path: 'list-commission-rule', loadComponent: () => import('./pages/list-commission-rule/list-commission-rule.component').then(m => m.ListCommissionRuleComponent), canActivate: [authGuard]},
			{path: 'list-offer', loadComponent: () => import('./pages/list-offer/list-offer.component').then(m => m.ListOfferComponent), canActivate: [authGuard]},
			{path: 'add-offer', loadComponent: () => import('./pages/save-offer/save-offer.component').then(m => m.SaveOfferComponent), canActivate: [authGuard]},
			{path: 'view-offer/:id', loadComponent: () => import('./pages/view-offer/view-offer.component').then(m => m.ViewOfferComponent), canActivate: [authGuard]},
		{path: 'add-commission-rule', loadComponent: () => import('./pages/save-commission-rule/save-commission-rule.component').then(m => m.SaveCommissionRuleComponent), canActivate: [authGuard]},
		...
		{path: 'commission-report', loadComponent: () => import('./pages/commission-report/commission-report.component').then(m => m.CommissionReportComponent), canActivate: [authGuard]},
			...
			{path: 'reporte-consecutivo-de-facturas-report', loadComponent: () => import('./pages/reporte-consecutivo-de-facturas-report/reporte-consecutivo-de-facturas-report.component').then(m => m.ReporteConsecutivoDeFacturasReportComponent), canActivate: [authGuard]},
			{path: 'ventas-netas-agrupado-por-cliente-agrupado-por-producto-report', loadComponent: () => import('./pages/ventas-netas-agrupado-por-cliente-agrupado-por-producto-report/ventas-netas-agrupado-por-cliente-agrupado-por-producto-report.component').then(m => m.VentasNetasAgrupadoPorClienteAgrupadoPorProductoReportComponent), canActivate: [authGuard]},
			...
			{path: 'item-purchase-price-report', loadComponent: () => import('./pages/item-purchase-price-report/item-purchase-price-report.component').then(m => m.ItemPurchasePriceReportComponent), canActivate: [authGuard]},
