...
export class SearchUsersComponent implements OnInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    private onChange: (value: User | null) => void = () => { };
