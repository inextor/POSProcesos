...
export const routes: Routes = [
	{path: 'login', loadComponent: () => import('./pages/login/login.component').then(m => m.LoginComponent)},
	{
		...
		{path: 'view-payment/:id', loadComponent: () => import('./pages/view-payment/view-payment.component').then(m => m.ViewPaymentComponent), canActivate: [authGuard]},
			...
			{path: 'list-commission-rules', loadComponent: () => import('./pages/list-commission-rules/list-commission-rules.component').then(m => m.ListCommissionRulesComponent), canActivate: [authGuard]},
		{path: 'add-commission-rules', loadComponent: () => import('./pages/save-commission-rules/save-commission-rules.component').then(m => m.SaveCommissionRulesComponent), canActivate: [authGuard]},
		{path: 'edit-commission-rules/:id', loadComponent: () => import('./pages/save-commission-rules/save-commission-rules.component').then(m => m.SaveCommissionRulesComponent), canActivate: [authGuard]},
