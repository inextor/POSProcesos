...
export interface TransferInfo
{
	...
	dest_bank_account:Bank_Account;
	bank_movements:Bank_Movement[];
}
...
export interface ConsignmentReceivedItemInfo
{
	...
	consignment_received_item_batches: Consignment_Received_Item_Batch[];
	item: Item;
	category: Category | null;
}
...
export interface ConsignmentDeliveredItemInfo
{
	...
	consignment_delivered_item_batches: Consignment_Delivered_Item_Batch[];
	item: Item;
	category: Category | null;
}
