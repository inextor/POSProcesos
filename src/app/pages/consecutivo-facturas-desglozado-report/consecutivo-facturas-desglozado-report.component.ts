...
@Component({
	...
	templateUrl: './consecutivo-facturas-desglozado-report.component.html',
	styleUrls: ['./consecutivo-facturas-desglozado-report.component.css']
})
export class ConsecutivoFacturasDesglozadoReportComponent extends BaseComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.setTitle('Reporte Detallado de Facturas');
	...
	generateReport() {
		...
		this.rest.httpPost('reports/consecutivo_facturas_desglozado.php', { 
